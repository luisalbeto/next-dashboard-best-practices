...
const getPokemon = async( name: string): Promise<Pokemon> => {
  ...
  const pokemon = await fetch(`https://pokeapi.co/api/v2/pokemon/${name}`,{
    //cache: 'force-cache' //TODO: cambiar esto para ver como funciona de diferente forma
     next:{
...
export default async function PokemonPage({ params }: Props) {
  ...
  return (
    <div className="flex mt-5 flex-col items-center bg-blue py-[50px] text-slate-800">
      <div className="relative flex flex-col items-center rounded-[20px] w-[700px] h-auto mx-auto bg-white bg-clip-border  shadow-lg  p-3">
